      ...
      <div class="row">
        <div class="col-md-6 mb-md-0 mb-4">
          <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
            <img loading="lazy" class="w-10 me-3 mb-0" src="@/assets/img/logos/mastercard.png" alt="logo" />
        ...
        <div class="col-md-6">
          <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
            <img loading="lazy" class="w-10 me-3 mb-0" src="@/assets/img/logos/visa.png" alt="logo" />
