          ...
          <tbody>
            <tr>
              <td>
                <div class="d-flex px-2">
                  <div>
                    <img loading="lazy" src="../../assets/img/small-logos/logo-spotify.svg"
            ...
            <tr>
              <td>
                <div class="d-flex px-2">
                  <div>
                    <img loading="lazy" src="../../assets/img/small-logos/logo-invision.svg"
            ...
            <tr>
              <td>
                <div class="d-flex px-2">
                  <div>
                    <img loading="lazy" src="../../assets/img/small-logos/logo-jira.svg"
            ...
            <tr>
              <td>
                <div class="d-flex px-2">
                  <div>
                    <img loading="lazy" src="../../assets/img/small-logos/logo-slack.svg"
            ...
            <tr>
              <td>
                <div class="d-flex px-2">
                  <div>
                    <img loading="lazy" src="../../assets/img/small-logos/logo-xd.svg"
