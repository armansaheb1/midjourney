<template>
    <div class="home" style="text-decoration: none; padding: 5%">
        <div v-for="item in posts" v-bind:key="item" class="card" style="margin: 10%">
            ...
            <div
                ...
                <h6
                    style="float: left; background: var(--bs-card-cap-bg); border-right:var(--bs-card-border-width) solid var(--bs-card-border-color); padding: 10px; margin: 0; cursor: pointer">
                    <a :href="`/blog/${item.id}`">Open Post</a>
                </h6>
            </div>
        </div>
    </div>
